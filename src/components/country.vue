<template>
  <div class="country">
    ...
    <img src="../assets/img/china.png" class="china-img" />
    <div class="goarea-box">
      <div class="goarea-item-1" @click="goarea()"></div>
      <div class="goarea-item-2" @click="goarea()"></div>
      <div class="goarea-item-3" @click="goarea()"></div>
    </div>
